...
class Speech {
  ...
  draw() {
    ...
    this.ctx.drawImage(speechBubble, this.x, this.y, this.width, this.height);
  }
}
...
class Roshi {
  ...
  draw() {
    ...
    this.ctx.drawImage(roshiImage, this.x, this.y, this.width, this.height);
  }
}
...
class Moon {
  ...
  draw() {
    ...
    this.ctx.drawImage(moonImage, this.x, this.y, this.width, this.height);
  }
}
...
class Ramen {
  ...
  draw() {
    ...
    this.ctx.drawImage(ramenImage, this.x, this.y, this.width, this.height);
  }
}
...
class Floor {
  ...
  draw() {
    ...
    this.ctx.drawImage(floorImage, this.x, this.y, this.width, this.height);
  }
}
